...
public class GetAllMovieQueryHandlerTests : IClassFixture<MovieApplicationFactory>
{
    ...
    private readonly MovieApplicationFactory Fixture;

    public GetAllMovieQueryHandlerTests(MovieApplicationFactory fixture)
    {
        Fixture = fixture;
    }
    [Fact]
